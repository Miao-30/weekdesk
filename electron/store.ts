...
export const defaults:Preferences={topmost:false,opacity:0.94,fontSize:14,todoFontSize:14,autoStart:false,showInactive:true,showWeekend:true,rememberLogin:true,theme:'soft',todoSort:'due',todoFilter:'today'};
